...
urlpatterns = [
    ...
    path('<uuid:company_uuid>/<uuid:building_uuid>/elevators/add/', AddElevatorToBuildingView.as_view(), name='add_elevator_to_building'),
