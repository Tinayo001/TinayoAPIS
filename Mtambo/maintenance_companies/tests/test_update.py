...
class MaintenanceCompanyTestCase(TestCase):
    ...
    def test_update_maintenance_company(self):
        ...
        """
        # Define the data for the full update request (including all required fields)
        data = {
            'user': self.user.id,
    ...
    def test_update_maintenance_company_invalid(self):
        """
        Test updating the maintenance company profile with invalid data using PUT (missing required fields).
        """
        # Define invalid data (missing company_name)
        data = {
